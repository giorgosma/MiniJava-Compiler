...
define i1 @Tree.Compare(i8* %this, i32 %.num1, i32 %.num2) {
	...
	%_1 = load i32, i32* %num2
	%_0 = add i32 %_1, 1
	store i32 %_0, i32* %nti

	%_3 = load i32, i32* %num1
	%_4 = load i32, i32* %num2
...
if2:
	...
	%_20 = load i32, i32* %v_key
	%_21 = load i32, i32* %key_aux
	%_19 = icmp slt i32 %_20, %_21
	br i1 %_19, label %if3, label %if4
...
if4:
	...
	br i1 %_57, label %if9, label %if10
...
if4:
	%_27 = load i32, i32* %key_aux
	%_28 = load i32, i32* %v_key
	%_26 = icmp slt i32 %_27, %_28
	br i1 %_26, label %if9, label %if10
...
if9:
	...
	br i1 %_35, label %if12, label %if13
...
if10:
	...
	br i1 %_44, label %if15, label %if16
...
if21:
	br i1 %_52, label %if22, label %if24
...
if23:
	br label %if24
if24:
	%_61 = phi i1 [0, %if21 ], [ %_60, %if23 ]
	br i1 %_61, label %if18, label %if19
...
if4:
	...
	%_25 = icmp slt i32 %_26, %_27
	br i1 %_25, label %if9, label %if10
...
if9:
	...
	br i1 %_34, label %if12, label %if13
